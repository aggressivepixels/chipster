...
runInstruction state instruction =
    ...
    case ( op, y, n ) of
        ...
        -- 8xy6 - SHR Vx
        ( 0x08, _, 0x06 ) ->
            setV (Bitwise.shiftRightZfBy 1 vy) x state
                |> setV (Bitwise.and 1 vy) 0x0F
                |> Ok
        ...
        -- 8xyE - SHL Vx
        ( 0x08, _, 0x0E ) ->
            setV (modBy 256 (Bitwise.shiftLeftBy 1 vy)) x state
                |> setV (Bitwise.shiftRightZfBy 7 vy) 0x0F
                |> Ok
